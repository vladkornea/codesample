...
trait PhotoTraits {
	...
	protected static $columnNames    = ['photo_id', 'user_id', 'caption', 'thumbnail_width', 'thumbnail_height', 'standard_width', 'standard_height', 'rotate_angle', 'deleted', 'updated', 'inserted'];
} // PhotoTraits
