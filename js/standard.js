...
function runLoginWidget () {
	...
	$loginWidget.on('click', handleWidgetClick)
	$loginLink.on('click', handleLoginLinkClick)
	$loginWidget.find('#logout-link').on('click', handleLogoutLinkClick)
	$loginWidget.find('#forgot-password-button').on('click', handleForgotPasswordClick)
