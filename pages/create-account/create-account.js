				...
				+'<tbody>'
					...
					+'</tr><tr>'
						...
						+'<td id="orientation-field-container">'
							+'<label><input type="radio" name="orientation" value="straight" aria-required="true" required="">Straight</label>'
							+'<label><input type="radio" name="orientation" value="gay" aria-required="true" required="">Gay</label>'
							+'<label><input type="radio" name="orientation" value="bi" aria-required="true" required="">Bi</label>'
						+'</td>'
					+'</tr><tr>'
