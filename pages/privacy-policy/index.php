...
<div id="privacy-policy-text">
	<h3>Cookies</h3>
	<ul>
		<li>TypeTango uses a <a href="https://www.php.net/manual/en/intro.session.php" target="_blank">standard PHP session cookie</a> that has been made <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Http-only_cookie" target="_blank">http-only</a>, and <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Secure_cookie" target="_blank">secure</a>. This cookie is used for temporarily storing anonymous data, such as confirmation messages between pages.</li>
		<li>When a user logs in, TypeTango sets an <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Http-only_cookie" target="_blank">http-only</a> <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Secure_cookie" target="_blank">secure</a> <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Session_cookie" target="_blank">session cookie</a> in order to stay logged in until the user's browser is closed. This cookie is made <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Persistent_cookie" target="_blank">persistent</a> if the "remember me" checkbox is checked at login. When a user logs out, this cookie is invalidated and deleted.</li>
