...
<div id="privacy-policy-text">
	<h3>Cookies</h3>
	<ul>
		<li>TypeTango sets a <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Secure_cookie" target="_blank">secure HttpOnly SameSite session cookie</a> to keep you logged in until your browser closes. This cookie is made <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Persistent_cookie" target="_blank">persistent</a> if "Remember me" is checked at login. Clicking "Log Out" removes this cookie.</li>
		<li>TypeTango sets a <a href="https://en.wikipedia.org/wiki/HTTP_cookie#Secure_cookie" target="_blank">secure HttpOnly SameSite session cookie</a> to store across subsequent anonymous requests temporary data such as notifications.</li>
